...
export namespace Music {
  ...
  */
 export interface PlaylistWindow extends Window {
   /**
    * the selected tracks
    */
   selection(): any;
 ...
 export interface PrintSettings {
   ...
   targetPrinter(): string;
    ...
    export interface ExportOptionalParameter {
      /**
       * the format to export for a playlist
       */
      as?: any;
      /**
...
export interface Music extends Music.Application {
    // Functions
      ...
      * 
      */
     print(directParameter?: any, option?: Music.PrintOptionalParameter): void;
      ...
      */
     count(directParameter: any, option?: Music.CountOptionalParameter): number;
      ...
      */
     duplicate(directParameter: any, option?: Music.DuplicateOptionalParameter): any;
      ...
      */
     make(option?: Music.MakeOptionalParameter): any;
      ...
      * 
      */
     move(directParameter: Music.Playlist, option?: Music.MoveOptionalParameter): void;
      ...
      */
     add(directParameter: {}, option?: Music.AddOptionalParameter): Music.Track;
      ...
      */
     convert(directParameter: {}, ): Music.Track;
      ...
      * 
      */
     download(directParameter: Music.Item, ): void;

     /**
      * export a source or playlist
      * @param directParameter the source or playlist to export
      * @param option
      * @return the exported data for the source or playlist, if not written to a file
      */
     export(directParameter: Music.Item, option?: Music.ExportOptionalParameter): string;
      ...
      * 
      */
     play(directParameter?: any, option?: Music.PlayOptionalParameter): void;
      ...
      * 
      */
     refresh(directParameter: Music.FileTrack, ): void;
      ...
      * 
      */
     reveal(directParameter: Music.Item, ): void;
      ...
      */
     search(directParameter: Music.Playlist, option?: Music.SearchOptionalParameter): Music.Track;
